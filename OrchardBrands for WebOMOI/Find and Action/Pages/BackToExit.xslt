...
<!-- Search criteria:                                                    -->
<!--   Find property Field ID with value "BACK".                         -->
<!--   Find property Image with value "Resources\bttn_arrowLeft_on.png". -->
<!-- Actions:                                                            -->
<!--   Set property Width to 63.                                         -->
<!--   Set property Center to Enabled.                                   -->
<!--   Set property Button style to Label.                               -->
<!--   Set property Decorator to .                                       -->
<!--   Set property Height to 27.                                        -->
<!--   Set property Background color to Normal.                          -->
<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" standalone="yes" />
<xsl:template match="ns:ajax_button">
  <xsl:choose>
      <xsl:when test="(./ns:image_file/text()[normalize-space() = normalize-space('Resources\bttn_arrowLeft_on.png')])">
        <xsl:copy>
           ...
           <dimensions>
             <xsl:attribute name="x"><xsl:value-of select="./ns:dimensions/@x - 14"/></xsl:attribute>
